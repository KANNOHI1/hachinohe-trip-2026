...
航空券は全便予約済み（宏勇JAL155/154・奈緒美JAL2815/2816、trip.ts反映済）。八戸の宿は空室料金の実態調査（じゃらん/楽天/公式をPlaywrightで横断）を経て**両泊とも宿決定**: 9/20=**JR東日本ホテルメッツ八戸**(yad309606・八戸駅直結・2名21,296円〜※シルバーウィーク5連休＋三沢基地航空祭9/20当日で市内相場2万超・予算15,000内は物理的に不存在、「飲まない」前提で最安のメッツ採用)、9/22=**スーパーホテル八戸天然温泉 三社の湯**(yad305810・期間限定プラン2名10,720円朝食温泉付・受付8/19まで残室少・**長流寺まで徒歩7分450m**)。次は**HKがじゃらんで2泊を予約**→完了報告を受けて trip.ts の「八戸中心街（宿未定）」を実宿に差替。公開URL: https://kannohi1.github.io/hachinohe-trip-2026/
最新リモート同期: 2026-08-02 12:00 JST — origin/main = HEAD (ahead 0 / behind 0)
