...
### サイト最終化フェーズ（次の主タスク）
- **HKがじゃらんで2泊を予約** ← 今ここ。9/20メッツ八戸(yad309606)・9/22三社の湯(yad305810・最安プランは受付8/19まで残室少なので早め推奨)→予約完了の報告を受けたら trip.ts の「八戸中心街（宿未定）」を実宿2軒に差替＆サイト反映（Codex委譲）＆_private/予約情報.md更新
